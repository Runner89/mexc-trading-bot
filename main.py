...
def webhook():
    ...
    if response.status_code == 200:
        ...
        if sell_limit_order is not None:
            ...
            # 1. Alle offenen Sell-Limit-Orders holen und löschen
            open_orders_resp, open_orders_debug = get_open_sell_limit_orders(symbol, api_key, secret_key)
            if "data" in open_orders_resp and isinstance(open_orders_resp["data"], list):
            ...
            # 2. Verfügbare Menge des Coins abfragen
